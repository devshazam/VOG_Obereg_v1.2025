...
import bannerImage from '../../public/b2.webp';
  ...
  return (
    <section className="banner">
        <div className="template__wrapper">
          <Row className="template__indent" gutter={16}>
            <Col xs={24} md={12}>
              <div className="flex justify-start items-center h-70 md:h-full py-6">
                <div className="">
               	<TransitionTextComp />
                  	<Text>Наша компания работает с 2011 года и все это время мы изо всех сил стараемся угодить клиентским запросам на высшем уровне!</Text>
                </div>
              </div>
            </Col>
